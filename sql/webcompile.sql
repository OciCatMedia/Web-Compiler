...
CREATE TABLE IF NOT EXISTS ocm_webcompile.site_section (
	...
	Section_Order TINYINT(1) UNSIGNED,
...
SELECT Nav_Title, Page_Path 

FROM ocm_webcompile.site_nav 

INNER JOIN ocm_webcompile.site_page 
ON site_nav.Page_ID = site_page.Page_ID 
INNER JOIN ocm_webcompile.site_section 
ON site_nav.Section_ID = site_section.Section_ID
AND Section_Title = "Foot"

 



ORDER BY site_section.Section_ID




/*		DEFAULT VALUES FOR OCICATMEDIA.COM		*/
INSERT INTO ocm_webcompile.site_section (Section_ID, Section_Title, Section_PrimNav, Section_Order) VALUES (1,"Site",0,0),(2,"Foot",0,0),(3,"Home",1,1),(4,"Blog",1,2),(5,"Portfolio",1,3),(6,"About",1,4),(7,"Contact",1,5);
...
INSERT INTO ocm_webcompile.site_nav (Nav_ID, Nav_Title, Section_ID, Page_ID) VALUES (1,"Home",1,1),(2,"Blog",1,2),(3,"Portfolio",1,3),(4,"About",1,7),(5,"Contact",1,11),(6,"Policies",2,12),(7,"Licenses",2,13),(8,"Sitemap",2,14),(9,"Photography",5,4),(10,"Drafting",5,5),(11,"Video",5,6),(12,"OciCat Media",6,8),(13,"Matthew Moore",6,9),(14,"The Ocicat",6,10);
